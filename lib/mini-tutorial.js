  ...
  MiniTutorial = (function() {
    ...
    MiniTutorial.prototype.template = function() {
      ...
      return "<button type='button' name='readymade-mini-tutorial-close'>" + this.closeLabel + "</button> <div class='readymade-mini-tutorial-images'> " + (((function() {
        ...
        return _results;
      }).call(this)).join('\n')) + " </div> <div class='readymade-mini-tutorial-actions'> <button type='button' name='readymade-mini-tutorial-previous'>" + this.previousLabel + "</button> <button type='button' name='readymade-mini-tutorial-next'>" + this.nextLabel + "</button> <button type='button' name='readymade-mini-tutorial-finish'>" + this.finishLabel + "</button> </div> <div class='readymade-mini-tutorial-steppers'> " + (((function() {
        var _i, _len, _ref, _results;
        _ref = this.steps;
        _results = [];
        for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
          step = _ref[i];
          _results.push("<button type='button' name='readymade-mini-tutorial-stepper' value='" + i + "'>" + (i + 1) + "</button>");
        }
        return _results;
      }).call(this)).join('\n')) + " </div>";
    };
