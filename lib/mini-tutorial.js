...
(function() {
  var $, MiniTutorial, TabSet, translate,
  ...
  MiniTutorial = (function() {
    ...
    MiniTutorial.prototype.previousLabel = translate('readymade.previous');

    MiniTutorial.prototype.nextLabel = translate('readymade.next');

    MiniTutorial.prototype.finishLabel = translate('readymade.finished');
