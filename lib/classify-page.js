...
(function() {
  var $, Api, ClassificationSummary, Classifier, ClassifyPage, DecisionTree, Dialog, DrawingTask, FieldGuide, MiniTutorial, StackOfPages, SubjectViewer, User, currentConfig, loginDialog, signupDialog, translate,
  ...
  ClassifyPage = (function(superClass) {
    ...
    function ClassifyPage() {
      ...
      if (this.tutorialSteps != null) {
        ...
        $(this.tutorial.el).on(this.tutorial.CLOSE_EVENT, function() {
          var ref;
          return (ref = User.current) != null ? ref.setPreference('tutorial_done', true) : void 0;
        });
      ...
      if (User.current != null) {
        ...
        $.when(project, talkUser).then((function(_this) {
          return function(project, talkUser) {
            var details, projectRoles, ref, ref1, ref2, ref3, ref4;
            projectRoles = (ref = (ref1 = talkUser.talk) != null ? (ref2 = ref1.roles) != null ? ref2[project.id] : void 0 : void 0) != null ? ref : [];
            details = {
              project: project.id,
              roles: projectRoles,
              scientist: indexOf.call(projectRoles, 'scientist') >= 0,
              admin: indexOf.call(projectRoles, 'admin') >= 0,
              'brian-c': (ref3 = talkUser.name) === 'brian-c' || ref3 === 'eatyourgreens'
            };
            if (typeof console !== "undefined" && console !== null) {
              console.log('Can you pick your own subject?', JSON.stringify(details, null, 2));
            }
            return result.resolve(indexOf.call(projectRoles, 'scientist') >= 0 || indexOf.call(projectRoles, 'admin') >= 0 || ((ref4 = talkUser.name) === 'brian-c' || ref4 === 'eatyourgreens'));
          };
        })(this));
      } else {
    ...
    ClassifyPage.prototype.onActivate = function(e) {
      ...
      if (this.targetSubjectID) {
        if (this.targetSubjectID !== ((ref = this.Subject.current) != null ? ref.zooniverse_id : void 0)) {
          this.getNextSubject();
        }
      }
      if (this.tutorial.el.getAttribute('aria-hidden') === 'false') {
        return setTimeout((function(_this) {
          return function() {
            var ref1;
            return (ref1 = _this.tutorial.active_button) != null ? ref1.focus() : void 0;
          };
        })(this));
      }
    };
    ...
    ClassifyPage.prototype.onUserChange = function(user) {
      var ref, ref1, ref2, tutorialDone;
      ...
      if (this.tutorial != null) {
        ...
        if (tutorialDone == null) {
          tutorialDone = user != null ? (ref1 = user.preferences) != null ? (ref2 = ref1[currentConfig.id]) != null ? ref2.tutorial_done : void 0 : void 0 : void 0;
        }
        if (tutorialDone) {
    ...
    ClassifyPage.prototype.updateDrawingTask = function() {
      ...
      return (ref1 = this.decisionTree.currentTask) != null ? ref1.reset(marks) : void 0;
    };
