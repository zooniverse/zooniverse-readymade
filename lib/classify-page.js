...
(function() {
  ...
  ClassifyPage = (function(_super) {
      ...
      if (User.current != null) {
        ...
        $.when(project, talkUser).then((function(_this) {
          return function(project, talkUser) {
            ...
            return result.resolve((projectRoles != null) && (__indexOf.call(projectRoles, 'scientist') >= 0 || __indexOf.call(projectRoles, 'admin') >= 0));
          };
        })(this));
      } else {
    ...
    ClassifyPage.prototype.onActivate = function(e) {
      ...
      if (idFromURL !== '') {
        if (((_ref = this.classification) != null ? _ref.subject.zooniverse_id : void 0) !== idFromURL) {
          return this.isUserScientist().then((function(_this) {
            return function(theyAre) {
              if (theyAre) {
                _this.targetSubjectID = idFromURL;
                return _this.getNextSubject();
              } else {
