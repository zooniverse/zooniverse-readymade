...
(function() {
  ...
  ClassifyPage = (function(_super) {
    ...
    ClassifyPage.prototype.onActivate = function(e) {
      var _ref;
      if (((_ref = this.classification) != null ? _ref.subject.zooniverse_id : void 0) !== e.originalEvent.detail.subjectID) {
        return this.isUserScientist().then((function(_this) {
          return function(theyAre) {
            if (theyAre) {
              _this.targetSubjectID = e.originalEvent.detail.subjectID;
              return _this.getNextSubject();
            } else {
              return alert('Sorry, only members of the science team can choose their subjects!');
            }
          };
        })(this));
      }
