...
(function() {
  var $, ClassificationSummary, Classifier, ClassifyPage, DecisionTree, DrawingTask, MiniTutorial, SubjectViewer, User, currentConfig,
  ...
  ClassifyPage = (function(_super) {
    ...
    function ClassifyPage() {
      ...
      if (this.tutorialSteps != null) {
        ...
        $(this.tutorial.el).on(this.tutorial.CLOSE_EVENT, (function(_this) {
          return function() {
            var _ref;
    ...
    ClassifyPage.prototype.showSummary = function() {
      ...
      return this.summaryContainer.show();
    };
