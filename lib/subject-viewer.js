...
(function() {
  ...
  SubjectViewer = (function(_super) {
    ...
    SubjectViewer.prototype.loadSubject = function(_at_subject, callback) {
      var frames, heights, i, imgSrc, loaded, subjectImages, widths, _ref;
      ...
      subjectImages = [].concat((_ref = this.subject.location.standard) != null ? _ref : this.subject.location);
      loaded = [];
      widths = [];
      heights = [];
      frames = (function() {
    ...
    SubjectViewer.prototype.goTo = function(_at_currentFrame) {
      var buttons;
      this.currentFrame = _at_currentFrame;
    ...
    SubjectViewer.prototype.setTaskIndex = function(_at_taskIndex) {
      var tool, _i, _ref, _results;
      this.taskIndex = _at_taskIndex;
    ...
    SubjectViewer.prototype.events = {
      'change input[name="hide-old-marks"]': function() {
        var hide, tool, _i, _len, _ref, _results;
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          tool = _ref[_i];
          tool.deselect();
          _results.push(tool.attr('data-hidden', hide ? true : null));
        }
        return _results;
      },
