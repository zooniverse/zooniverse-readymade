...
(function() {
  ...
  SubjectViewer = (function(superClass) {
    ...
    SubjectViewer.prototype.loadSubject = function(subject, callback) {
      var frames, heights, i, imgSrc, loaded, ref, subjectImages, widths;
      ...
      subjectImages = [].concat((ref = this.subject.location.standard) != null ? ref : this.subject.location);
      loaded = [];
      widths = [];
      heights = [];
      frames = (function() {
    ...
    SubjectViewer.prototype.events = {
      'change input[name="hide-old-marks"]': function() {
        var hide, j, len, ref, results, tool;
