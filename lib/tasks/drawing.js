  ...
  DrawingTask = (function(_super) {
    ...
    DrawingTask.prototype.enter = function() {
      ...
      if (this.choices.length === 1) {
        this.check(this.choices[0].value);
    ...
    DrawingTask.prototype.check = function(value) {
      var _ref;
      if ((_ref = this.el.querySelector('input:checked')) != null) {
        _ref.checked = false;
      }
      if (value != null) {
        return this.el.querySelector("[value=" + value + "]").checked = true;
      }
    };
