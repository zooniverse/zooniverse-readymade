...
(function() {
  ...
  Project = (function() {
    ...
    function Project(configuration) {
      var examples, firstTask, footer, hash, href, j, k, key, label, len, len1, newContent, page, property, ref, ref1, ref2, ref3, subjectGroup, tasks, title, tmp, tutorialSteps, value;
