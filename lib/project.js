...
(function() {
  ...
  Project = (function() {
    ...
    function Project(configuration) {
      var content, firstTask, footer, homePage, key, label, page, property, subjectGroup, tasks, title, value, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3;
      ...
      if (this.summary || this.description) {
        homePage = this.addPage('#/', 'Home', homePageTemplate(this));
