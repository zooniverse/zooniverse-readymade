...
(function() {
  ...
  Project = (function() {
    ...
    function Project(configuration) {
      var content, firstTask, footer, key, label, newContent, page, property, subjectGroup, tasks, title, tutorialSteps, value, _i, _j, _len, _len1, _ref, _ref1, _ref2;
      ...
      if (this.pages != null) {
        ...
        for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
          ...
          for (title in page) {
            ...
            this.addPage("#/" + (dash(title)), title, newContent);
          }
        }
      }
