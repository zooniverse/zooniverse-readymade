...
(function() {
  var Api, ClassifyPage, Profile, Project, SiteBackground, SiteHeader, StackOfPages, TabSet, TopBar, User, ZooniverseFooter, dash, homePageTemplate, teamPageTemplate,
    __slice = [].slice;
  ...
  Project = (function() {
    ...
    Project.prototype.makeStackFromPages = function(pages, currentPath) {
      var container, content, description, hash, i, id, mapOfHashes, nav, prefix, stack, title, _i, _len;
      if (currentPath == null) {
        currentPath = [];
      }
      mapOfHashes = {
    ...
    Project.prototype.buildTabset = function(tabs, panels, prefix, stack) {
      var i, panel, tab, tabset, _i, _len, _results;
      tabset = new TabSet;
      _results = [];
